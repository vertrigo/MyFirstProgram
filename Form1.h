...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(94, 62);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(94, 88);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(94, 114);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(94, 140);
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(95, 166);
			this->textBox6->Name = L"textBox6";
			this->textBox6->Size = System::Drawing::Size(190, 20);
			this->textBox6->TabIndex = 5;
			this->textBox6->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &Form1::KeyEnter);
			// 
			// label1
			// 
			...
			this->label3->Location = System::Drawing::Point(32, 88);
			...
			this->label4->Location = System::Drawing::Point(32, 117);
			...
			this->label6->Location = System::Drawing::Point(32, 169);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(251, 237);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(128, 237);
			...
			this->label7->Location = System::Drawing::Point(314, 37);
			...
			// label8
			// 
			this->label8->Location = System::Drawing::Point(360, 37);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(396, 237);
			...
			this->groupBox1->Size = System::Drawing::Size(397, 209);
			this->groupBox1->TabIndex = 17;
			this->groupBox1->TabStop = false;
			this->groupBox1->Text = L"Форма ввода";
			// 
			// Form1
			// 
...
private: System::Void KeyEnter(System::Object^  sender, System::Windows::Forms::KeyPressEventArgs^  e) {
